...
import 'package:restobuy_restaurant_flutter/presentation/libraries/flutter_toast.dart';
...
String parseHtmlString(String htmlString) {
 ...
 void saveCartCount(BuildContext context, count){
   try {
     MySharedPreferences().saveCartItemCount(count);
...
void showIosDialog(BuildContext context, String title, String content, String btn1Txt, String btn2Txt, Function() onClose){
  showDialog(
    context: context,
