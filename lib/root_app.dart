...
import 'package:restobuy_restaurant_flutter/presentation/fade_page_route_builder.dart';
...
class _RootAppState extends State<RootApp> {
  ...
  void initMessaging() async {
    ...
    const AndroidNotificationChannel channel = AndroidNotificationChannel(
      'restobuy_restaurant_channel_id',
      'RestoBuy Restaurant', // title
      description: 'This notification is from  RestoBuy Restaurant', // description
