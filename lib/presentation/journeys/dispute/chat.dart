...
import 'package:restobuy_restaurant_flutter/data/models/chats_api_res_model.dart';
...
import 'package:restobuy_restaurant_flutter/presentation/themes/theme_text.dart';
            ...
            if (isApiDataAvailable) {
              ...
              for (int i = 0; i < model.response!.length; i++) {
                ...
                final msgBubble = MessageBubble(
                    msgText: msgText,
                    msgSender: msgSender,
                    user: currentUser == 'Restaurant'? false: true,
                );
