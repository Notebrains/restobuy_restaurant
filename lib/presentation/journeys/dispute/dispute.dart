...
import 'package:restobuy_restaurant_flutter/data/models/dispute_api_res_model.dart';
import 'package:restobuy_restaurant_flutter/data/models/status_message_api_res_model.dart';
import 'package:restobuy_restaurant_flutter/presentation/journeys/dispute/chat.dart';
...
class _OrdersState extends State<Dispute> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(context: context, title: 'Dispute'),
                            ...
                            Navigator.push(context,
                              MaterialPageRoute(builder: (context) =>
                                  ChatScreen(
                                    ...
                                    supplierName: model.response![index].supplierName?? '',
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        tooltip: 'Pressed',
        elevation: 5,
        label: const Text('Raise Dispute', style: TextStyle(color: Colors.black, fontSize: 14),),
        isExtended: true,
