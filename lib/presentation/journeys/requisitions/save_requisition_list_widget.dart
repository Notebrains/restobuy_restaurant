...
class SaveRequisitionListWidget extends StatelessWidget {
  final List<Save_requisitions> response;
  final int index;
  ...
  const SaveRequisitionListWidget({
    Key? key,
      ...
      return InkWell(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Txt(
                txt: 'Template name - ${response[index].template}',
