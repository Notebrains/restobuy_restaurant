...
import 'package:restobuy_restaurant_flutter/presentation/journeys/purchase_order_details/purchase_order_details.dart';
...
import 'package:restobuy_restaurant_flutter/presentation/widgets/drop_down_dialog_sort.dart';
...
class _OrdersState extends State<PurchaseOrder> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(context: context, title: 'Purchase Order'),
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (BuildContext context) => PurchaseOrderDetails(
                                        ...
                                        supplierName: model.response![index].supplierName.toString(),
